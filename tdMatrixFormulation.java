...
public class tdMatrixFormulation {
	
	//This function stores the triplet <term, docId, Frequency> in the mysql database
	public void establishConnection(String term, Integer document, Integer frequency)throws ClassNotFoundException, SQLException{
		Connection c = null;
		...
		String insertTableSQL = "INSERT INTO dbtuple" + "(TERM, DOCUMENT, FREQUENCY) VALUES"+ "(?,?,?)";
		preparedStatement = (PreparedStatement) ((java.sql.Connection) c).prepareStatement(insertTableSQL);
...
public List<Integer> TermDocMatix(String inputFile, String termDocMatrix, String docTermMatrix, String TDMtf, String DCMtf) throws IOException, ClassNotFoundException, SQLException, NumberFormatException, InterruptedException{
	...
	long startTime = System.nanoTime();
	    ...
	    column = f.getFileContent("C://Users/Titli Sarkar/workspace/IRAssignment/cran.all.1400")+1;
	...
	// writing the TDM with tf weights to file 
     ...
     //writing doc term matrix with tf weights to file 
	   ...
	   long endTime = System.nanoTime();
	    ...
	    System.out.println("Time taken for term-document-matrix formation is : "+ duration + " nanoseconds");
	    return (dimension);
