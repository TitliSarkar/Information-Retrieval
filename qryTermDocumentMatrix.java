/**
 * This file creates a hashmap of term document matrix (i.e Dictionary) of the form hashmap<String, List<Integer>>, which stores terms and list of their corresponding documents where  they are contained.
 */
...
public class qryTermDocumentMatrix {
...
public void buildTermDocMatix(String inputFile, String termDocMatrix) throws IOException{
	...
	long startTime = System.nanoTime();
	    ...
	    System.out.println("Number of unique words in the query collection is: " + no_of_unique_word);
	    reader.close();
	    out1.close();
	    long endTime = System.nanoTime();
	    long duration = (endTime - startTime);  //divide by 1000000 to get milliseconds.
	    System.out.println("Time taken for qry-dictionary formation is : "+ duration + " nanoseconds");
